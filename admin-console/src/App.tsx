...
const resolveApiBase = () => {
  if (typeof window !== "undefined") {
    ...
    if (hostname === "localhost" || hostname === "127.0.0.1" || window.location.port === "5174" || window.location.port === "5173" || window.location.port === "3000") {
      let url = (import.meta.env && import.meta.env.VITE_API_URL) || "http://localhost:8000/api";
