...
def update_current_user_profile(
    ...
    """Update profile fields with anti-tampering guards on email."""
...
async def upload_avatar(
    ...
    # 4. Save to secure uploads folder
...
def get_active_sessions(
    ...
    """List active devices and sessions for the current user."""
...
def get_security_events(
    ...
    """Retrieve security audit history for the authenticated user."""
    events = (
...
def delete_account(
    ...
    Preserves historical booking/payment/invoice data for accounting & compliance.
    """
    if not req.confirm:
        raise HTTPException(
            status_code=400,
